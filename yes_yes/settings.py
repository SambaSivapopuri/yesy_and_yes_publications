"""
Django settings for yes_yes project.
...
SECRET_KEY = 'django-insecure-ixd96ldkz&6hrjr2v77k+#=3%@yvas8bnczg$$eusb37^xgaj-'
...
WSGI_APPLICATION = 'yes_yes.wsgi.application'
